...
export function Sidebar({ onSelect, activeFilter }: SidebarProps) {
  return (
    <div className="w-20 lg:w-72 h-screen border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col transition-all duration-300 fixed left-0 top-0 z-20">
      ...
      <div className="flex items-center gap-3 p-6 mb-4 justify-center lg:justify-start">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white hidden lg:block whitespace-nowrap">
          Second Brain
        </h1>
      </div>
